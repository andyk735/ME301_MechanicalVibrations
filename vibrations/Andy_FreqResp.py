...
from control.matlab import tf, bode  # MATLAB-like control toolbox functionality
...
# Workshop: Unforced Response
c = 0.1*2*m*np.sqrt(k/m)        #(a)
c = 7 # Overdamped

# Workshop: Forced Response
F0 = 1
c = 0.1*2*m*np.sqrt(k/m)
wf = np.sqrt(k/m)       # resonance
wf = 0.1 + np.sqrt(k/m)
f0 = F0/m
